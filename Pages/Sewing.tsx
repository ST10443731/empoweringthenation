  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContent}>
        ...
        <Text style={styles.textDetails}>- Types of stitches</Text>
        <Text style={styles.textDetails}>- Threading a sewing machine</Text>
        <Text style={styles.textDetails}>- Sewing buttons, zips, hems, and seams</Text>
        <Text style={styles.textDetails}>- Alterations</Text>
        <Text style={styles.textDetails}>- Designing and sewing new garments</Text>
      </View>
